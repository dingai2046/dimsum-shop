...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 1780,
    originalPrice: null,
    image: "/images/products/shaomai.jpg",
    images: ["/images/products/shaomai.jpg"],
    categoryId: "cat-popular",
    stock: 80,
    isActive: true,
    sortOrder: 2,
  },
  {
    ...
    price: 1780,
    originalPrice: null,
    image: "/images/products/xiajiao.jpg",
    images: ["/images/products/xiajiao.jpg"],
    categoryId: "cat-popular",
    stock: 90,
    isActive: true,
    sortOrder: 3,
  ...
  // ========== 云吞 ==========
  {
    ...
    price: 1880,
    originalPrice: null,
    image: "/images/products/wonton.jpg",
    images: ["/images/products/wonton.jpg"],
  ...
  // ========== 煎类 ==========
  {
    ...
    price: 1780,
    originalPrice: null,
    image: "/images/products/guotie.jpg",
    images: ["/images/products/guotie.jpg"],
