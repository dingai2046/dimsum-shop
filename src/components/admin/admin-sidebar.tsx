...
import { Package, ShoppingCart, LayoutDashboard, ArrowLeft, Grid3X3, Settings, Users, Ticket, Star, Gift } from "lucide-react";
...
export function AdminSidebar() {
  ...
  const navItems = [
    ...
    { href: "/admin/campaigns" as const, label: t("campaigns"), icon: Gift },
